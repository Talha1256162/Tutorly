...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'dashboard', component: StudentDashboardComponent, canActivate: [AuthGuard], data: { roles: ['student', 'parent', 'admin'] } },
      { path: 'saved-tutors', component: SavedTutorsComponent, canActivate: [AuthGuard], data: { roles: ['student', 'parent', 'admin'] } },
      { path: 'my-bookings', component: MyBookingsComponent, canActivate: [AuthGuard], data: { roles: ['student', 'parent', 'admin'] } },
      { path: 'tutor-dashboard', component: TutorDashboardComponent, canActivate: [AuthGuard], data: { roles: ['tutor', 'admin'] } },
    ],
  },
  { path: 'messages', component: MessagesComponent, canActivate: [AuthGuard], data: { roles: ['student', 'parent', 'tutor', 'admin'] } },
