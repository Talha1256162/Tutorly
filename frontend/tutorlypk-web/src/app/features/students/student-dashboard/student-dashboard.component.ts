      ...
      <section class="mx-auto max-w-7xl px-6 py-8">
        <div class="glass-strong rounded-3xl p-8 shadow-card bg-hero-gradient">
          <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div><div class="text-cyan text-xs font-bold uppercase tracking-wider mb-2"><app-icon name="sparkles" className="h-3 w-3 inline-block mr-1" /> Welcome back</div><h1 class="font-display text-4xl font-bold">{{ dashboard.headline }} 👋</h1><p class="text-muted-foreground mt-2">{{ dashboard.subheadline }}</p></div>
            <a routerLink="/tutors" class="inline-flex items-center gap-2 rounded-xl bg-primary-gradient px-6 py-3.5 font-semibold text-primary-foreground shadow-glow">Find more tutors</a>
          </div>
        </div>
        ...
        <div class="grid lg:grid-cols-[1.4fr_1fr] gap-6 mt-8">
          <div class="space-y-6">
            <section class="glass-strong rounded-3xl p-7 shadow-card">
              <div class="flex justify-between mb-5"><h2 class="font-display text-xl font-semibold">Recommended for you</h2><a routerLink="/tutors" class="text-sm text-muted-foreground">See all →</a></div>
            ...
            <section class="glass-strong rounded-3xl p-7 shadow-card">
              <h2 class="font-display text-xl font-semibold mb-6">Learning progress</h2>
          ...
          <div class="space-y-6">
            <section class="glass-strong rounded-3xl p-7 shadow-card">
              <h2 class="font-display text-xl font-semibold mb-5">Upcoming demo classes</h2>
            ...
            <section class="glass-strong rounded-3xl p-7 shadow-card">
              <div class="flex justify-between mb-5"><h2 class="font-display text-xl font-semibold">Messages</h2><a routerLink="/messages" class="text-sm text-muted-foreground">Open inbox →</a></div>
